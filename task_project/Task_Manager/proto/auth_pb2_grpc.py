...
from task_project.Task_Manager.proto import auth_pb2 as auth__pb2
...
class AuthServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Authenticate = channel.unary_unary(
                '/authentication.grpc_config.AuthService/Authenticate',
...
def add_AuthServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'authentication.grpc_config.AuthService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('authentication.grpc_config.AuthService', rpc_method_handlers)
